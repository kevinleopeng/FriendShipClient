  ...
  <div >
    <el-row type="flex" class="row-bg row-first">
      <el-col :span="20">
        ...
        <el-button type="warning" size='large' icon="date" class="add-btn" @click="refreshAndNotifyRenters">刷新并通知租客</el-button>
      </el-col>
    </el-row>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      getData() {
        var _this = this;
        this.$ajax.get('http://localhost:8080/fsr.web/collectrent/getCollectRentByType?page='+this.page+'&pageSize='+this.pageSize+'&type=1').then(res => {
